...
class body extends generic {
	...
	public function End(){
		...
		$eventOnKeyPress .= " onLoad=\"preAfterLoad();".$this->onLoadFunction."\"";
		...
		if(!@$NO_BOTTOM && $NO_REPOSITION_CORPO!==true){
			$this->e("<style>#corpo{ position:relative;width:100%;padding:0% 2% 0% 2%;box-sizing:border-box; }</style>");
