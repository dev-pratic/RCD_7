...
class textBox extends generic {
	...
	public function End(){
		...
		if($this->loadJava===true){
			$this->e($this->textInside."<input type=\"".$this->type."\" id=\"".$this->name."\" name=\"".$this->name."\" value=\"".$this->value."\" class=\"".$this->Class."\" maxlength=\"".$this->maxlen."\"".$this->disabled.$this->readOnly.$this->java->getLineCommand()." step=\"".$this->step."\" style=\"".$styles."\"/>".$this->br,$this->nivel);
		}else{
			$this->e($this->textInside."<input type=\"".$this->type."\" id=\"".$this->name."\" name=\"".$this->name."\" value=\"".$this->value."\" class=\"".$this->Class."\" maxlength=\"".$this->maxlen."\"".$this->disabled.$this->readOnly." step=\"".$this->step."\" style=\"".$styles."\"/>".$this->br,$this->nivel);
		}
		if(strlen($this->textInside)>0){
